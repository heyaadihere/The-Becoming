      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-8 font-sans text-charcoal/80 leading-relaxed">
          ...
          <section>
            ...
            <p>You have the right to access, correct, or request deletion of your personal data. To exercise these rights, contact us at hello@enteryourbecoming.com.</p>
          </section>
          ...
          <p className="border-t border-sand pt-6 text-sm text-charcoal/60 italic">
            Last updated: February 2026. For questions, contact hello@enteryourbecoming.com.
          </p>
        </div>
      </main>
