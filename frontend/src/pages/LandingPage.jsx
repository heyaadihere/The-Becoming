...
import { ArrowRight, ArrowLeft, Check, Loader2, X, ChevronLeft, ChevronRight, Mail, Instagram, Linkedin, MessageCircle, Phone } from 'lucide-react';
...
export const QuestionnaireModal = ({ isOpen, onClose }) => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      setFieldError(e.response?.data?.detail || 'Failed to send OTP. Please try again.');
                  ...
                  <div>
                    ...
                    <div className="phone-input-wrapper">
                      <PhoneInput
                        ...
                        className={`w-full bg-white/50 border-b-2 px-2 py-3 text-lg text-deep-charcoal focus-within:border-accent-gold font-sans ${fieldError && answers.name?.trim() && !otpVerified ? 'border-red-400' : 'border-sand'}`}
